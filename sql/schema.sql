...
CREATE TABLE IF NOT EXISTS tpsl_recommendations (
    ...
    strategy_profile VARCHAR(64) NULL COMMENT 'strategy profile name',
    chart_exit_enabled TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'chart exit enabled flag',
    chart_exit_action VARCHAR(32) NULL COMMENT 'chart exit action',
    chart_exit_reason VARCHAR(64) NULL COMMENT 'chart exit reason',
    chart_exit_stop_trigger_price DECIMAL(20, 6) NULL COMMENT 'chart hard stop trigger',
    chart_exit_stop_limit_price DECIMAL(20, 6) NULL COMMENT 'chart hard stop limit',
    chart_exit_position_scale DECIMAL(10, 6) NULL COMMENT 'entry position scale from chart profile',
    chart_exit_held_peak_close DECIMAL(20, 6) NULL COMMENT 'held peak close used by chart exit',
    chart_exit_trend_active TINYINT(1) NULL COMMENT 'chart trend state flag',
    chart_exit_trade_days INT NULL COMMENT 'chart trade days from entry',
    chart_exit_diagnostic VARCHAR(500) NULL COMMENT 'chart exit diagnostics',
